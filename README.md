...
`-- transaction_analysis (1).ipynb # Data preparation, analysis, charts, and models
```
...
PaySim is a synthetic dataset designed to imitate mobile money activity. The patterns and model results in this project demonstrate an analytical approach, but they should not be treated as evidence of how a live banking system will behave. A production fraud model would need validation with real transaction data, changing fraud patterns, customer behavior, and the financial cost of false alerts and missed fraud.
...
# 3. Run the notebook
jupyter notebook "transaction_analysis (1).ipynb"
```
